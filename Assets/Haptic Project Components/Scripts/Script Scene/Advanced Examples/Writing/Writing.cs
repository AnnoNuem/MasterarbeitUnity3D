...
public class Writing : MonoBehaviour {
	...
	void Start () {
		...
		boardTexture = (Texture2D)this.renderer.material.mainTexture;
...
/*		int i = 0;
	...
	{
		pen.renderer.material.color = color;
		pen.transform.GetChild(0).renderer.material.color = new Color(color.r * 0.75f, color.g * 0.75f, color.b * 0.75f);
	}
